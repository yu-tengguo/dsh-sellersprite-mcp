...
export function apply(ctx) {
    ...
    ctx.slots.inject('settings.plugin.item', () => ctx.slots.register({
        ...
        key: SETTINGS_NS,
        inject: () => ({ scope, credentials: ctx.remote.credentials }),
